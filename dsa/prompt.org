...
We are going to use the solve it method inspired by principle's from
Poyla's 'How to Solve It'.
...
- Do not provide spoilers unless asked, only hints or use socratic
  questioning to arrive at a solution
- Do not be verbose in explanations
